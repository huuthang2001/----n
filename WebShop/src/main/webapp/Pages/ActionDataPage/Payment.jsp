...
<body>
	...
	<div>
		<form class="form-container" id="customForm" method="post">
			...
			<div class="field-container">
				<label for="money">Deposit amount(VND)</label> <input id="money"
					name="money" type="text" value="100000" />
			</div>
		...
		<div class="field-container">
			<button class="button">
				<span class="submit">Submit</span> <span class="loading"><i
   ...
   button.addEventListener('click',()=>{ setTimeout(submitForm, 3000);});
   </script>
