					...
					<div class="product-count">
						...
						<div>
								...
								if (accesser != null && accesser.equals("user") && client != null)
									out.print("<form method='post' action='GioHang'>" + "<input style='display: none' name='clientID' value='" + client.getId() + "'>"
									+ "<input style='display: none' name='productID' value='" + p.getId() + "'>"
