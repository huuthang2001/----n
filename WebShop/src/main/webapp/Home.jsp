		...
		<div class="sw" style="width: auto;">
			<form method="get"
				...
				<a href="#" class="logo" title="Tuulkit"> <img
					src="/WebShop/style/assets/images/logoShop/LOGO CAMSPORT.png" alt="">
				</a>
			</form>
		</div>
		...
		<div style="background-color: #FFFF;">
			...
			<div class="Products-hot">
				<div class="Product-hot">
					<a href="<%=request.getContextPath()%>/Trangchu/Product?id=1">
						<div>
				...
				<div class="Product-hot">
					<a href="<%=request.getContextPath()%>/Trangchu/Product?id=5">
						<div>
							<span class="span-hot"></span> <span class="spans"><p
									style="color: #FFFF; font-size: 14px; text-align: center;">Đã
									bán 11,1K</p></span> <img
				...
				<div class="Product-hot">
					<a href="<%=request.getContextPath()%>/Trangchu/Product?id=7">
						<div>
							<span class="span-hot"></span> <span class="spans"><p
									style="color: #FFFF; font-size: 14px; text-align: center;">Đã
									bán 11,1K</p></span> <img
